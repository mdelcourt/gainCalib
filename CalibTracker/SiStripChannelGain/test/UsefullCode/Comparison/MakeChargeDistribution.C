...
void MakeChargeDistribution(){
   ...
   PlotMacro_Core("file:256630_to_256729.root", "file:256734_to_256936.root", "SiStripCalib"          , "Checks");
}


TF1* getPeakOfLandau(TH1* InputHisto, string name, double LowRange=50, double HighRange=5400)
{ 
   // perform fit with standard landau
   TF1* MyLandau = new TF1(name.c_str(),"landau",LowRange, HighRange);
